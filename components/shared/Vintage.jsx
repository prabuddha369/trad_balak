...
const Vintage = () => {
    ...
    return (
        <section id='vintage' className='h-full text-black py-[10%] flex flex-col justify-center items-center'>
            <h1 className='text-3xl text-[#404040] pb-6'>VINTAGE WEAR</h1>
                        ...
                        <Link href={`../products/${item.id}`}>
                            <div className="flex flex-col place-items-center justify-center md:w-full">
                                <Image src={getDirectGoogleDriveUrl(item.imgUrl[0])} alt={item.name}
                                    ...
                                    height="0"
                                    sizes="100vw"
                                    className="w-[28vh] h-[40vh] md:h-[42vh]" />
                            </div>
